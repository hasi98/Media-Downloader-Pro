...
**A fast, lightweight YouTube video & audio downloader with advanced control**
...
- **Precision Clipping**  
  Download only a specific time range (e.g. `01:15 – 02:45`) without downloading the full video.

- **Thumbnail Ripper**  
  Extract maximum-resolution thumbnails in one click.

- **Smart History**  
  Automatically skips videos you've already downloaded to avoid duplicates and save disk space.

- **Authentication Support**  
  Import cookies from Chrome, Edge, or Brave to access age-restricted or private content you have permission to view.

- **Playlist & Channel Downloads**  
  Download full playlists or entire channels in one click.
...
2. Run the installer (`Media Downloader Pro v1.exe`)  
...
2. Paste it into Media Downloader Pro  
3. Choose:
   - Video quality (1080p / 4K)  
   - Or Audio format (MP3 / WAV / M4A)  
4. (Optional) Set clip time range  
5. Click **Download**
...
1. Log in to YouTube in Chrome / Edge / Brave  
2. In the app, go to **Settings → Import Cookies**  
